...
class AiChatCompressorContextEndBriefEvent(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['compressor-context-end']):
            raise ValueError("must be one of enum values ('compressor-context-end')")
        return value
