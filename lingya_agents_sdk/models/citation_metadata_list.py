...
class CitationMetadataList(BaseModel):
    """
    CitationMetadataList 的公开协议结构。 / Public contract for citation metadata list.
    """ # noqa: E501
    records: List[CitationMetadata] = Field(description="记录列表 / records。")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "records": [CitationMetadata.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None
        })
        return _obj
