...
class ConversationActivityList(BaseModel):
    """
    ConversationActivityList 的公开协议结构。 / Public contract for conversation activity list.
    """ # noqa: E501
    records: List[ConversationActivity] = Field(description="记录列表 / records。")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "records": [ConversationActivity.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None
        })
        return _obj
