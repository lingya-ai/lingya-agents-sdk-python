...
class AiChatCompressorContextStartBriefEvent(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['compressor-context-start']):
            raise ValueError("must be one of enum values ('compressor-context-start')")
        return value
