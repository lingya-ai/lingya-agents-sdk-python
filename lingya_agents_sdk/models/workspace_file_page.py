...
class WorkspaceFilePage(BaseModel):
    ...
    """ # noqa: E501
    records: List[WorkspaceFile] = Field(description="记录列表 / records。")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "records": [WorkspaceFile.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None,
